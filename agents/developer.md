...
- Read the project's `CLAUDE.md` first, then the design's testing and TDD section, then the requirements file of your feature (`docs/features/e-N-<slug>/requirements.md`) for the story's acceptance criteria. Follow the `team-workflow` skill: TDD by vertical slice.
