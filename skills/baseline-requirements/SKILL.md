...
In the project's `docs/business-prd.md` (the solution overview), a short section "Applied baseline". It holds for every feature; a feature file may add deviations for that feature only, each with a reason:
